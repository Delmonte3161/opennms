...
public abstract class ConfigFileConstants {
    ...
    /**
     * The text file holding all grok patterns.
     */
    public static final int GROK_PATTERN_FILE_NAME;
    ...
    static {
        ...
        FILE_ID_TO_NAME[GROK_PATTERN_FILE_NAME] ="grok-patterns.txt";
    }
